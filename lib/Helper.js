...
const getZoneData = async () => {
  try {
    const value = await AsyncStorage.getItem('yourZone');
    if (value !== null) {
      console.log('this is from get data', value);
      return value;
    }
  } catch (e) {
    console.log(e);
...
const getSettingsData = async () => {
  try {
    await AsyncStorage.getItem('yourSettings').then((res) => {
      console.log(res);
      return res;
    });
  } catch (e) {
...
const storeZoneData = async (value) => {
  try {
...
const storeSettingsData = async (value) => {
  try {
    await AsyncStorage.setItem('yourSettings', value);
  } catch (e) {
    console.log(e);
  }
};
